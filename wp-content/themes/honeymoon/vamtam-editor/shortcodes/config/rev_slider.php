<?php
return array(
	'name' => __('Revolution Slider', 'honeymoon') ,
	...
	If you need to activate the slider in the Header, then you will need the option - "Page Slider" found below the editor. ' , 'honeymoon'),
	'icon' => array(
