...
class WpvFramework {
	...
	public function theme_supports() {
		 ...
		 */
		if( ! isset( $content_width ) ) $content_width = wpv_get_option('site-max-width') - 2*60;
		...
		if ( function_exists( 'register_nav_menus' ) ) {
			register_nav_menus(
				array(
					'menu-header' => __( 'Menu Header', 'honeymoon' ),
					'menu-top' => __( 'Menu Top', 'honeymoon' ),
				)
			);
		}
	...
	private function load_languages() {
		load_theme_textdomain( 'honeymoon', THEME_DIR . 'languages' );
	}
	...
	public function load_types() {
		...
		register_post_type(
			'portfolio', array(
				'labels' => array(
					'name' => _x( 'Portfolios', 'post type general name', 'honeymoon' ),
					'singular_name' => _x( 'Portfolio', 'post type singular name', 'honeymoon' ),
					'add_new' => _x( 'Add New', 'portfolio', 'honeymoon' ),
					'add_new_item' => __( 'Add New Portfolio', 'honeymoon' ),
					'edit_item' => __( 'Edit Portfolio', 'honeymoon' ),
					'new_item' => __( 'New Portfolio', 'honeymoon' ),
					'view_item' => __( 'View Portfolio', 'honeymoon' ),
					'search_items' => __( 'Search Portfolios', 'honeymoon' ),
					'not_found' => __( 'No portfolios found', 'honeymoon' ),
					'not_found_in_trash' => __( 'No portfolios found in Trash', 'honeymoon' ),
					'parent_item_colon' => '',
				),
				'singular_label' => __( 'portfolio', 'honeymoon' ),
				'public' => true,
		...
		register_taxonomy(
				...
				'hierarchical' => true,
				'labels' => array(
					'name' => _x( 'Portfolio Categories', 'taxonomy general name', 'honeymoon' ),
					'singular_name' => _x( 'Portfolio Category', 'taxonomy singular name', 'honeymoon' ),
					'search_items' => __( 'Search Portfolio Categories', 'honeymoon' ),
					'popular_items' => __( 'Popular Portfolio Categories', 'honeymoon' ),
					'all_items' => __( 'All Portfolio Categories', 'honeymoon' ),
					'parent_item' => null,
					'parent_item_colon' => null,
					'edit_item' => __( 'Edit Portfolio Category', 'honeymoon' ),
					'update_item' => __( 'Update Portfolio Category', 'honeymoon' ),
					'add_new_item' => __( 'Add New Portfolio Category', 'honeymoon' ),
					'new_item_name' => __( 'New Portfolio Category Name', 'honeymoon' ),
					'separate_items_with_commas' => __( 'Separate Portfolio category with commas', 'honeymoon' ),
					'add_or_remove_items' => __( 'Add or remove portfolio category', 'honeymoon' ),
					'choose_from_most_used' => __( 'Choose from the most used portfolio category', 'honeymoon' )
				),
				'show_ui' => true,
				'query_var' => true,
				'rewrite' => false,
		...
		register_post_type(
			'testimonials', array(
				'labels' => array(
					'name' => _x( 'Testimonials', 'post type general name', 'honeymoon' ),
					'singular_name' => _x( 'Testimonial', 'post type singular name', 'honeymoon' ),
					'add_new' => _x( 'Add New', 'testimonials', 'honeymoon' ),
					'add_new_item' => __( 'Add New Testimonial', 'honeymoon' ),
					'edit_item' => __( 'Edit Testimonial', 'honeymoon' ),
					'new_item' => __( 'New Testimonial', 'honeymoon' ),
					'view_item' => __( 'View Testimonial', 'honeymoon' ),
					'search_items' => __( 'Search Testimonials', 'honeymoon' ),
					'not_found' => __( 'No testimonials found', 'honeymoon' ),
					'not_found_in_trash' => __( 'No testimonials found in Trash', 'honeymoon' ),
					'parent_item_colon' => '',
				),
				'singular_label' => __( 'testimonial', 'honeymoon' ),
				'public' => true,
		...
		register_taxonomy(
			'testimonials_category','testimonials',array(
				'hierarchical' => true,
				'labels' => array(
					'name' => _x( 'Testimonials Category', 'taxonomy general name', 'honeymoon' ),
					'singular_name' => _x( 'Testimonial Category', 'taxonomy singular name', 'honeymoon' ),
					'search_items' => __( 'Search Categories', 'honeymoon' ),
					'popular_items' => __( 'Popular Categories', 'honeymoon' ),
					'all_items' => __( 'All Categories', 'honeymoon' ),
					'parent_item' => null,
					'parent_item_colon' => null,
					'edit_item' => __( 'Edit Testimonials Category', 'honeymoon' ),
					'update_item' => __( 'Update Testimonials Category', 'honeymoon' ),
					'add_new_item' => __( 'Add New Testimonials Category', 'honeymoon' ),
					'new_item_name' => __( 'New Testimonials Category Name', 'honeymoon' ),
					'separate_items_with_commas' => __( 'Separate Testimonials category with commas', 'honeymoon' ),
					'add_or_remove_items' => __( 'Add or remove testimonials category', 'honeymoon' ),
					'choose_from_most_used' => __( 'Choose from the most used testimonials category', 'honeymoon' )
				),
				'show_ui' => true,
				'query_var' => false,
				'rewrite' => false,
	...
	public function setup_adminbar() {
		...
		$wp_admin_bar->add_menu(
			array(
				'parent' => false,
				'id' => 'wpv-settings',
				'title' => __( 'Vamtam', 'honeymoon' ),
				'href' => admin_url( 'admin.php?page=wpv_general' ),
				'meta' => false,
			)
		);

		$adv_name = __( 'Theme options', 'honeymoon' );

		$pages = array(
			'general' => __( 'General Settings', 'honeymoon' ),
			'layout' => __( 'Layout', 'honeymoon' ),
			'styles' => __( 'Styles', 'honeymoon' ),
			'import' => __( 'Quick Import', 'honeymoon' ),
			'help' => __( 'Help', 'honeymoon' ),
		);
