...
class WpvEnqueues {
	...
	public static function scripts() {
		...
		$script_vars = array(
			'content_width' => $content_width + 2*60,
		);
	...
	public static function admin_scripts() {
		...
		wp_localize_script(
			'wpv_admin', 'WPV_ADMIN', array(
				...
				'addNewIcon' => __( 'Add New Icon', 'honeymoon' ),
				'iconName' => __( 'Icon', 'honeymoon' ),
				'iconText' => __( 'Text', 'honeymoon' ),
				'iconLink' => __( 'Link', 'honeymoon' ),
				'iconChange' => __( 'Change', 'honeymoon' ),
